...
public class DifferentDataInPassword {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		ChromeDriver driver = new ChromeDriver();
		        ...
		        driver.findElement(By.xpath("//div[@class='mb-3']//input[@id='password']")).sendKeys("Qwerty@1234");
		            driver.findElement(By.xpath("//div[@class='mb-3 ']//input[@id='password']")).sendKeys("Qwerty@12345");
		   		...
		   		System.out.println("Change Password Failed");
		   			...
		   			System.out.println("Change Password Passed");
		   			otppage = true;
		   		}
