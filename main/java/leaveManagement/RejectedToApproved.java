...
public class RejectedToApproved {
	...
	public static void main(String[] args) {
        ...
        WebElement Status = driver.findElement(By.xpath("/html/body/div/div[2]/div[1]/main/div[1]/div[3]/div/div[2]/div/div[3]/table/tbody/tr[1]/td[8]/div/div/select"));
...
boolean StatusChange =driver.findElement(By.xpath("/html/body/div/div[2]/div[1]/main/div[1]/div[3]/div/div[2]/div/div[3]/table/tbody/tr[1]/td[2]/div/div")).getText().contains("Antony");
System.out.println(StatusChange);		
if (StatusChange){
	    	System.out.println("Status changed to approved");
	    }else{ 
	    	System.out.println("Status not changed to approved");
	    }
	driver.close();
