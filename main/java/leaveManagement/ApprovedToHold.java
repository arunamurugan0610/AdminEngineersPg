...
public class ApprovedToHold {
	...
	public static void main(String[] args) {
        ...
        dropdown.selectByVisibleText("Hold"); 
	    driver.findElement(By.xpath("//span[normalize-space()='Hold']")).click();
	
boolean StatusChange =driver.findElement(By.xpath("/html/body/div/div[2]/div[1]/main/div[1]/div[3]/div/div[2]/div/div[3]/table/tbody/tr/td[2]/div/div")).getText().contains("Antony");
