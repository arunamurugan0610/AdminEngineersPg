...
public class ValiddataToCreateEmployee {
		...
		try{		
 		...
 		try{
			...
			driver.findElement(By.xpath("//*[@id=\"root\"]/div[2]/div[1]/main/div[1]/div[3]/div[1]/div[2]/input")).sendKeys("Murugan");
			...
			driver.findElement(By.cssSelector("input[placeholder='Enter email address']")).sendKeys("test@gmail.com");
			...
			driver.findElement(By.cssSelector("textarea[placeholder='Enter address']")).sendKeys("Address");
		       CharSequence[]	dob ={"23-09-2023"};
		         WebElement dob_field = driver.findElement(By.xpath( "//div[contains(@class,'h-full w-full pb-6 bg-base-100')]//div[3]//input[1]"));
				    dob_field.click();
				    dob_field.clear();			    
				    dob_field.sendKeys(dob);
				    dob_field.sendKeys(Keys.ENTER);				 
					CharSequence[]	doj ={"23-09-2023"};
			         WebElement doj_field = driver.findElement(By.xpath("//*[@id=\"root\"]/div[2]/div[1]/main/div[1]/div[3]/div[1]/div[4]/input"));
			         doj_field.click();
			         doj_field.clear();			    
			         doj_field.sendKeys(dob);
			         doj_field.sendKeys(Keys.ENTER);
			         WebElement role = driver.findElement(By.xpath("//*[@id=\"root\"]/div[2]/div[1]/main/div[1]/div[3]/div[1]/div[7]/select")); // Replace with the actual element locator
			            Select employeeRole = new Select(role);
			            employeeRole.selectByVisibleText("manager");     
			            WebElement gender = driver.findElement(By.xpath("//*[@id=\"root\"]/div[2]/div[1]/main/div[1]/div[3]/div[1]/div[8]/select")); // Replace with the actual element locator
 		...
 		driver.findElement(By.xpath("//button[normalize-space()='Create']")).click();
                   WebElement Compare=  driver.findElement(By.xpath("a[href='/app/employee']"));
